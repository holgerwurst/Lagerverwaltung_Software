...
public class Übersicht_Lagerverwaltung extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textfeld_bezeichnung.setToolTipText("Die Bezeichnung muss eindeutig sein. Legen Sie nicht 2 verschiedene Teile mit der gleichen Bezeichnung an.");
        ...
        textfeld_zeichnungsnummer.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textfeld_zeichnungsnummerActionPerformed(evt);
            }
        });
        ...
        textfeld_max_anz_klein.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        textfeld_max_anz_klein.setToolTipText("Die maximale Anzahl dieses Teils, die in einen kleinen Lagerbehälter passen soll.");
        Teilestamm_erweitern.add(textfeld_max_anz_klein);
        textfeld_max_anz_klein.setBounds(450, 130, 154, 21);

        textfeld_max_anz_mittel.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        textfeld_max_anz_mittel.setToolTipText("Die maximale Anzahl dieses Teils, die in einen mittleren Lagerbehälter passen soll.");
        Teilestamm_erweitern.add(textfeld_max_anz_mittel);
        textfeld_max_anz_mittel.setBounds(450, 160, 154, 21);

        textfeld_max_anz_gross.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        textfeld_max_anz_gross.setToolTipText("Die maximale Anzahl dieses Teils, die in einen großen Lagerbehälter passen soll.");
        Teilestamm_erweitern.add(textfeld_max_anz_gross);
        textfeld_max_anz_gross.setBounds(450, 190, 154, 21);

        label_waehrung.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
    ...
    private void textfeld_id1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textfeld_id1ActionPerformed
        ...
        private void button_anlegenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_anlegenActionPerformed
            ...
            //FIX: hier wird immer nur ein fixer enumTyp übergeben unabhängung der combobox =>Betafix

            tec.nutzeranforderung(textfeld_bezeichnung.getText(), TeileTypET.kaufteile, textfeld_materialgruppe.getText(), textfeld_zeichnungsnummer.getText(), textfeld_baugruppe.getText(), AnschaffungsTextField.getText(), textfeld_preis.getText(), textfeld_max_anz_klein.getText(), textfeld_max_anz_mittel.getText(), textfeld_max_anz_gross.getText(), jTextArea1.getText());
    ...
    private void textfeld_zeichnungsnummerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textfeld_zeichnungsnummerActionPerformed
        // TODO add your handling code here:
