...
public class Teil_auslagern_controller {
    ...
    /**
     *
     * Kontrolle Anzahl vorhandener Faecher. Update des Lagerfachstammes, der
     * Faecher, in denen Menge auf 0 fiel.
     *
     * retunr 0 - letztes Fach fiel auf 0 -> Konto löschen und Teil entfernen
     * anbieten. return 1 -
     *
     * @param id
     * @param laenge
    ...
    /**
     *
     * Die statische Methode fuehrt beim Ausloesen des ausfuehren_button das
     * Auslagern aus und aktualiesiert die jTable.
     *
     *
     * @param ul
     */
    ...
    /**
     *
     * Die statische Methode zeigt alle Faecher und Mengenbelegungen der
     * gewaehlten ID in der jTable an.
     *
     *
     * @param ul
     */
